...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 500.0, 311.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 389.0, 139.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 156.0, 497.0, 229.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.slab recolor @file cwjr.brightness.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 536.75, 449.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
,
					"patching_rect" : [ 536.75, 393.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 536.75, 362.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.75, 421.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "dim $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 536.75, 512.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 536.75, 482.0, 125.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 536.75, 540.0, 257.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.slab recolor @file cwjr.gaussian.kernel.jxs"
				}
...
, 			{
				"box" : 				{
					"data" : 					{
						"clips" : [ 							{
								"filename" : "Morning Glories 11_08.mov",
								"filekind" : "moviefile",
								"loop" : 1,
								"content_state" : 								{
									"outputmode" : [ 1 ],
...
,
					...
					"patching_rect" : [ 425.0, 31.0, 150.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1278.5, 284.0, 427.0, 98.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 848.5, 284.0, 427.0, 98.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 61.0, 439.0, 41.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 156.0, 540.0, 243.0, 22.0 ],
					"style" : "",
...
, 			{
				"name" : "monsoon_6.mov",
				"bootpath" : "~/Documents/Max 7/CWJR-Instruments/Recolor/media",
				"patcherrelativepath" : "../media",
				"type" : "MooV",
				"implicit" : 1
			}
, 			{
				"name" : "Morning Glories 11_08.mov",
				"bootpath" : "~/synthesis-git/media/video/SERRA",
				"patcherrelativepath" : "../../../../../synthesis-git/media/video/SERRA",
				"type" : "MooV",
				"implicit" : 1
			}
 ],
